...
import { ConsultationService, ConsultationResult } from "@/utils/ai/consultation/consultationService";
...
export function AIBookingConsultation({ onComplete, onCancel }: AIBookingConsultationProps) {
